defmodule ApiAppWeb.ItemControllerTest do
  use ApiAppWeb.ConnCase

  import ApiApp.ItemsFixtures

  @create_attrs %{"item-name": "some item-name", "item-trait": "some item-trait"}
  ...
  describe "update item" do
    ...
    test "redirects when data is valid", %{conn: conn, item: item} do
      ...
      assert html_response(conn, 200) =~ "some updated item-name"
    end
